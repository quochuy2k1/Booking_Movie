...
namespace Booking_Movie.Data.Configurations
{
    internal class SeatNoConfiguration : IEntityTypeConfiguration<SeatNo>
    {
        public void Configure(EntityTypeBuilder<SeatNo> builder)
        {
            ...
            builder.Property(x => x.SeatStyleId).IsRequired(false);
            ...
            builder.HasOne(s => s.SeatStyle).WithMany(s => s.SeatNos).HasForeignKey(x => x.SeatStyleId).HasConstraintName("fk_seatno_seatstyle");
        }
    }
}