        ...
        public static void Seed(this ModelBuilder modelBuilder)
        {
           ...
           modelBuilder.Entity<Screening>().HasData(
            ...
            modelBuilder.Entity<SeatNo>().HasData(
                new SeatNo() { Id = ++i, SeatId = "A1", AuditoriumId = 1, Stauts = false},
                new SeatNo() { Id = ++i, SeatId = "A2", AuditoriumId = 1, Stauts = false},
                new SeatNo() { Id = ++i, SeatId = "A3", AuditoriumId = 1, Stauts = false},
                new SeatNo() { Id = ++i, SeatId = "A4", AuditoriumId = 1, Stauts = false},
                new SeatNo() { Id = ++i, SeatId = "A5", AuditoriumId = 1, Stauts = false},
                new SeatNo() { Id = ++i, SeatId = "A6", AuditoriumId = 1, Stauts = false},
                new SeatNo() { Id = ++i, SeatId = "A7", AuditoriumId = 1, Stauts = false},
                new SeatNo() { Id = ++i, SeatId = "A8", AuditoriumId = 1, Stauts = false},
                new SeatNo() { Id = ++i, SeatId = "A9", AuditoriumId = 1, Stauts = false},
                new SeatNo() { Id = ++i, SeatId = "A10", AuditoriumId = 1, Stauts = false},
                new SeatNo() { Id = ++i, SeatId = "A11", AuditoriumId = 1, Stauts = false},
                new SeatNo() { Id = ++i, SeatId = "A12", AuditoriumId = 1, Stauts = false},
                new SeatNo() { Id = ++i, SeatId = "B1", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "B2", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "B3", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "B4", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "B5", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "B6", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "B7", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "B8", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "B9", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "B10", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "B11", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "B12", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "C1", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "C2", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "C3", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "C4", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "C5", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "C6", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "C7", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "C8", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "C9", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "C10", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "C11", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "C12", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "D1", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "D2", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "D3", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "D4", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "D5", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "D6", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "D7", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "D8", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "D9", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "D10", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "D11", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "D12", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "E1", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "E2", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "E3", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "E4", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "E5", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "E6", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "E7", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "E8", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "E9", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "E10", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "E11", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "E12", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "F1", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "F2", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "F3", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "F4", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "F5", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "F6", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "F7", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "F8", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "F9", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "F10", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "F11", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "F12", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "G1", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "G2", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "G3", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "G4", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "G5", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "G6", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "G7", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "G8", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "G9", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "G10", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "G11", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "G12", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "H1", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "H2", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "H3", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "H4", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "H5", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "H6", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "H7", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "H8", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "H9", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "H10", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "H11", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "H12", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "I1", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "I2", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "I3", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "I4", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "I5", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "I6", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "I7", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "I8", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "I9", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "I10", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "I11", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "I12", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "J1", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "J2", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "J3", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "J4", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "J5", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "J6", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "J7", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "J8", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "J9", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "J10", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "J11", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "J12", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "J13", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "J14", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "K1", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "K2", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "K3", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "K4", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "K5", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "K6", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "K7", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "K8", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "K9", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "K10", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "K11", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "K12", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "K13", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "K14", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "L1", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "L2", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "L3", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "L4", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "L5", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "L6", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "L7", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "L8", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "L9", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "L10", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "L11", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "L12", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "L13", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "L14", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "L15", AuditoriumId = 1, Stauts = false },
                new SeatNo() { Id = ++i, SeatId = "L16", AuditoriumId = 1, Stauts = false });
