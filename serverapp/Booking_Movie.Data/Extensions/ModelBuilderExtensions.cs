    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Booking>().HasData(
                    ...
                    new Booking() { Id = 2, AppUserId = Guid.Parse("ab778d64-0d3e-4ab6-bc7c-a50b93de737b"), ScreeningId = 2, PaymentMethodId = 1, CouponId = 2, Total = 250000, Stauts = true },
                    new Booking() { Id = 3, AppUserId = Guid.Parse("d83ac55f-ef97-468f-a493-e9a8eeec395e"), ScreeningId = 3, PaymentMethodId = 1, CouponId = 2, Total = 15000, Stauts = true },
                    new Booking() { Id = 4, AppUserId = Guid.Parse("C8A04D06-2334-4806-92A6-6F6DB3ED6692"), ScreeningId = 4, PaymentMethodId = 1, CouponId = 2, Total = 20000, Stauts = true },
                    new Booking() { Id = 5, AppUserId = Guid.Parse("d83ac55f-ef97-468f-a493-e9a8eeec395e"), ScreeningId = 5, PaymentMethodId = 1, CouponId = 2, Total = 560000, Stauts = true },
                    new Booking() { Id = 6, AppUserId = Guid.Parse("dea78e4f-c2b7-451f-77d1-08dac47f52e7"), ScreeningId = 5, PaymentMethodId = 1, CouponId = 2, Total = 1000000, Stauts = true },
                    new Booking() { Id = 7, AppUserId = Guid.Parse("dea78e4f-c2b7-451f-77d1-08dac47f52e7"), ScreeningId = 10, PaymentMethodId = 1, CouponId = 2, Total = 75000, Stauts = true }
                );
            ...
            modelBuilder.Entity<BookingCombo>().HasData(
                ...
                new BookingCombo() { Id = 4, BookingId = 3, ComboId = 3, Quantity = 1, Stauts = true },
                new BookingCombo() { Id = 5, BookingId = 4, ComboId = 1, Quantity = 1, Stauts = true },
                new BookingCombo() { Id = 6, BookingId = 4, ComboId = 2, Quantity = 1, Stauts = true },
                new BookingCombo() { Id = 7, BookingId = 5, ComboId = 3, Quantity = 1, Stauts = true },
                new BookingCombo() { Id = 8, BookingId = 6, ComboId = 1, Quantity = 3, Stauts = true },
                new BookingCombo() { Id = 9, BookingId = 7, ComboId = 2, Quantity = 3, Stauts = true },
                new BookingCombo() { Id = 10, BookingId = 7, ComboId = 1, Quantity = 1, Stauts = true }
                );
            modelBuilder.Entity<BookingTicket>().HasData(
                ...
                new BookingTicket() { Id = 3, BookingId = 2, TicketId = 1, Quantity = 1, Stauts = true },
                new BookingTicket() { Id = 4, BookingId = 2, TicketId = 2, Quantity = 1, Stauts = true },
                new BookingTicket() { Id = 5, BookingId = 3, TicketId = 1, Quantity = 1, Stauts = true },
                new BookingTicket() { Id = 6, BookingId = 4, TicketId = 2, Quantity = 3, Stauts = true },
                new BookingTicket() { Id = 7, BookingId = 5, TicketId = 2, Quantity = 2, Stauts = true },
                new BookingTicket() { Id = 8, BookingId = 6, TicketId = 1, Quantity = 3, Stauts = true },
                new BookingTicket() { Id = 9, BookingId = 7, TicketId = 2, Quantity = 1, Stauts = true }
                );
            ...
            modelBuilder.Entity<SeatReserved>().HasData(
                ...
                new SeatReserved() { Id = 4, BookingId = 2, SeatNoId = 5, Stauts = true },
                new SeatReserved() { Id = 5, BookingId = 2, SeatNoId = 6, Stauts = true },
                new SeatReserved() { Id = 6, BookingId = 3, SeatNoId = 7, Stauts = true },
                new SeatReserved() { Id = 7, BookingId = 4, SeatNoId =8, Stauts = true },
                new SeatReserved() { Id = 8, BookingId = 4, SeatNoId =9, Stauts = true },
                new SeatReserved() { Id = 9, BookingId = 4, SeatNoId =10, Stauts = true },
                new SeatReserved() { Id = 10, BookingId = 5, SeatNoId =25, Stauts = true },
                new SeatReserved() { Id = 11, BookingId = 5, SeatNoId =26, Stauts = true },
                new SeatReserved() { Id = 12, BookingId = 6, SeatNoId =36, Stauts = true },
                new SeatReserved() { Id = 13, BookingId = 6, SeatNoId =37, Stauts = true },
                new SeatReserved() { Id = 14, BookingId = 6, SeatNoId =38, Stauts = true },
                new SeatReserved() { Id = 15, BookingId = 7, SeatNoId = 40, Stauts = true }
                );
        }
    }
}
