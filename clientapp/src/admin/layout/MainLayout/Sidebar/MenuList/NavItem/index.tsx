...
import { MenuOpen, SetMenu } from '../../../../../../slices/customizations/customizationsSlice';
...
const NavItem : React.FC<{ item: any, level: number }> = ({ item, level }) => {
    ...
    let listItemProps: any = {
        component: forwardRef<HTMLAnchorElement, LinkProps>((props, ref) => <Link ref={ref} {...props} to={item.url} target={itemTarget} />)
    };
    if (item?.external) {
