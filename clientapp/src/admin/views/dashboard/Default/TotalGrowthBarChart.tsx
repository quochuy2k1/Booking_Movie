...
// chart data
import TotalGrowBarOptions, { seriesBar } from './chart-data/total-growth-bar-chart';
...
const TotalGrowthBarChart: React.FC<{isLoading: boolean}> = ({ isLoading }) => {
            ...
            {isLoading ? (
                ...
                <MainCard>
                    <Grid container spacing={gridSpacing}>
                        ...
                        <Grid item xs={12}> 
                            <Chart type='bar' height={480} options={TotalGrowBarOptions} series={seriesBar} />
                        </Grid>
                    </Grid>
                </MainCard>
            )}
