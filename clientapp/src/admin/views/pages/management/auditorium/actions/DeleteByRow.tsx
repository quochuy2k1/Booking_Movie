...
interface IProps {
    open: boolean,
    rows: string[],
    onSubmit?: (deleteRow: string[]) => void,
    handlClose?: () => void
}
...
const DeleteByRowAction: React.FC<IProps> = (props) => {
        ...
        >
            ...
            <DialogContent>
                <DialogContentText id="alert-dialog-description">
                    Dòng sẽ xóa theo dòng mà bạn chỉ định
                </DialogContentText>
                            ...
                            return (
                                ...
                                >
                                    <ListItemButton role={undefined} onClick={handleToggle(value)} dense>
                                        ...
                                        <ListItemText id={labelId} primary={`Dòng ${value} (${value.includes(".1")  ? String.fromCharCode(parseInt(value) + 64) + "0" : String.fromCharCode(parseInt(value) + 64) })`} />
                                    </ListItemButton>
                                </ListItem>
                            );
                        })}
...
export default DeleteByRowAction;