...
import { IDataGirdColumn } from "../../../../ui-component/common/Dropdown/DropdownWithDataGrid";
...
import { ComboModel } from "../../../../../slices/combos/comboSlice";
...
const ComboManagement: React.FC = () => {
    ...
    const [dataSource, setDataSource] = React.useState<CustomStore<ComboModel, string>>();
    ...
    useEffect(() => {
        const data = createStore({
            key: 'id',
            loadMethod: "POST",
            loadUrl: `${url}/api/combos/paging/admin`,
            loadParams: {
                ...filter
            },
            insertUrl: `${url}/api/combos/create`,

            updateUrl: `${url}/api/combos/update`,
