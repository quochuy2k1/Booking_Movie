...
import { SignInAsync, UserState } from "./userSlice";
import { Grid, Header, Form, Segment, Button, Message, Image, Modal, Icon } from "semantic-ui-react";
                        ...
                        <Grid textAlign='center' verticalAlign='middle'>
                            <Grid.Column style={{ maxWidth: 450 }}>
                                <Header as='h2' color='teal' textAlign='center'>
                                    <Image src='/logo.png' /> Đăng nhập tài khoản của bạn
                                </Header>
                                <Form size='large'>
                                    <Segment stacked>
                                        <Form.Input
                                        ...
                                        <Button color='teal' loading={this.props.status === "loading"} disabled={this.props.status === "loading"} fluid size='large' onClick={this.onSign}>
                                            Đăng nhập
                                        </Button>
                                    </Segment>
                                </Form>
