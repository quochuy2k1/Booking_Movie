...
import { Button, Card, Container, Dropdown, Grid, Header, Icon, Image, Tab } from "semantic-ui-react";
import { useAppDispatch, useAppSelector } from "../../app/hooks";
import { MoviePagingRequest } from "../../services/movie.service";
import { GetAllMoviePagingAsync, Movie } from "./movieSlice";
import "./movie.css"
...
const MovieList: React.FC<{}> = ({ }) => {
    ...
    const { movies, total } = useAppSelector((state) => state.movie)

    const [movieBG, setMovieBG] = useState({} as Movie);
