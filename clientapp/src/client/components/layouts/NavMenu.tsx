...
import './NavMenu.css';
import { Container, Dropdown, Input, Menu, MenuItemProps, Image, Sidebar, Icon } from 'semantic-ui-react';
...
const NavBarChildren = (props: { children: React.ReactNode }) => {
    ...
    return (
        <Container fluid style={{ marginTop: "5em", paddingLeft: "2rem", paddingRight: "2rem" }}>
            {props.children}
            <Outlet/>
        </Container>
    )
